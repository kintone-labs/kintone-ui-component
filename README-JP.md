...
> 現在 Node LTS v16.15.1 とそれ以降の環境下で "npm ci" を利用して依存ライブラリのインストールをすることができません。 <br>
> npm v8.5.5 以降で package-lock.json のチェックが厳格化されたのが原因です。現時点では Node v16.15.1 以前をお使いください。<br>
> この問題は近々修正する予定です。
