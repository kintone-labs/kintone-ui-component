...
class KucAttachment extends KucBase {
  ...
  @query(".kuc-attachment__group__files__browse-button__input-container__input")
    ...
    return html`
      <div class="kuc-attachment__group">
        ...
        >
          ...
          <div
            class="kuc-attachment__group__files__browse-button${this._isDraging
              ? " kuc-attachment__group__files__not-droppable--dragenter"
              : ""}"
...
export { KucAttachment as Attachment };
