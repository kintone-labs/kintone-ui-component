...
import Alert from '../legacyJS/js/components-react/Alert'
import Label from '../legacyJS/js/components-react/Label'
import IconButton from '../legacyJS/js/components-react/IconButton'
import NotifyPopup from '../legacyJS/js/components-react/NotifyPopup'
