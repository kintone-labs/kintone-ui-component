...
const NotifyPopup = ({setStyles, setClassName, text, type, isDisabled, isVisible, onClick, onClose}: NotifyPopupProps) => {
  ...
  return (
    <div style={setStyles} className={`${_getClassName()} ${setClassName}`}>
