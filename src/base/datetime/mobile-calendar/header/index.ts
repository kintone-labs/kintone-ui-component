...
import { MobileSelectItem } from "../../../datetime/mobile-time";
...
export class BaseMobileDateTimeCalendarHeader extends KucBase {
  ...
  @state()
  private _monthOptions!: MobileSelectItem[];
  @state()
  private _yearOptions!: MobileSelectItem[];
