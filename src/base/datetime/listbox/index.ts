...
(() => {
  exportBaseDateTimeListBox = window.customElements.get(
    "kuc-base-datetime-listbox"
  );
  if (exportBaseDateTimeListBox) {
    return;
  }
  ...
  class KucBaseDateTimeListBox extends KucBase {
    ...
    private _getNextItemEl() {
      ...
      let nextItemEl = this._highlightItemEl
    ...
    private _getPreviousItemEl() {
      ...
      if (this._itemSelectedEl.previousElementSibling) {
        prevItemEl = this._itemSelectedEl
          .previousElementSibling as HTMLLIElement;
        return prevItemEl;
      }
  ...
  window.customElements.define(
    "kuc-base-datetime-listbox",
    KucBaseDateTimeListBox
  );
  createStyleOnHeader(LISTBOX_CSS);
  exportBaseDateTimeListBox = KucBaseDateTimeListBox;
})();
const BaseDateTimeListBox = exportBaseDateTimeListBox as any;
