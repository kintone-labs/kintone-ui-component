...
let exportBaseDateTimeCalendarBody;
(() => {
  exportBaseDateTimeCalendarBody = window.customElements.get(
    "kuc-base-datetime-calendar-body"
  );
  if (exportBaseDateTimeCalendarBody) {
    return;
  }
  class KucBaseDateTimeCalendarBody extends KucBase {
    ...
    @query(
      '.kuc-base-datetime-calendar-body__table__date__button[tabindex="0"]'
    )
            ...
            return html`
              <tr>
                ${weeks.map((weekDate: WeekDate) => {
                  ...
                  const isThisMonth =
                    parseInt(dateParts[1], 10) === this._month;
                  return html`
                    <td
                      role="gridcell"
  ...
  window.customElements.define(
    "kuc-base-datetime-calendar-body",
    KucBaseDateTimeCalendarBody
  );
  exportBaseDateTimeCalendarBody = KucBaseDateTimeCalendarBody;
})();
const BaseDateTimeCalendarBody = exportBaseDateTimeCalendarBody as any;
export { BaseDateTimeCalendarBody };
