...
(() => {
  exportDatePicker = window.customElements.get(
  ...
  class KucexportBaseDateTimeHeaderMonth extends KucBase {
  ...
  window.customElements.define(
    "kuc-base-datetime-header-month",
    KucexportBaseDateTimeHeaderMonth
  );
  exportDatePicker = KucexportBaseDateTimeHeaderMonth;
})();
const BaseDateTimeHeaderMonth = exportDatePicker as any;
