...
import { DROPDOWN_MONTH_CSS } from "./style";

let exportBaseDateTimeHeaderMonth;
(() => {
  exportBaseDateTimeHeaderMonth = window.customElements.get(
    "kuc-base-datetime-header-month"
  );
  if (exportBaseDateTimeHeaderMonth) {
    return;
  }

  class KucBaseDateTimeHeaderMonth extends KucBase {
  ...
  window.customElements.define(
    "kuc-base-datetime-header-month",
    KucBaseDateTimeHeaderMonth
  );
  createStyleOnHeader(DROPDOWN_MONTH_CSS);
  exportBaseDateTimeHeaderMonth = KucBaseDateTimeHeaderMonth;
})();
const BaseDateTimeHeaderMonth = exportBaseDateTimeHeaderMonth as any;
export { BaseDateTimeHeaderMonth };
