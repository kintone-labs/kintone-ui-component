...
import { BaseDateTimeHeaderMonth } from "./header/dropdown/month/type";
import { BaseDateTimeHeaderYear } from "./header/dropdown/year/type";
...
let exportBaseDateTimeCalendar;
(() => {
  exportBaseDateTimeCalendar = window.customElements.get(
    "kuc-base-datetime-calendar"
  );
  if (exportBaseDateTimeCalendar) {
    return;
  }

  class KucBaseDateTimeCalendar extends KucBase {
  ...
  window.customElements.define(
    "kuc-base-datetime-calendar",
    KucBaseDateTimeCalendar
  );
  createStyleOnHeader(CALENDAR_CSS);
  exportBaseDateTimeCalendar = KucBaseDateTimeCalendar;
})();
const BaseDateTimeCalendar = exportBaseDateTimeCalendar as any;
