...
let exportBaseDateTimeCalendarFooter;
(() => {
  exportBaseDateTimeCalendarFooter = window.customElements.get(
    "kuc-base-datetime-calendar-footer"
  );
  if (exportBaseDateTimeCalendarFooter) {
    return;
  }

  class KucBaseDateTimeCalendarFooter extends KucBase {
  ...
  window.customElements.define(
    "kuc-base-datetime-calendar-footer",
    KucBaseDateTimeCalendarFooter
  );
  exportBaseDateTimeCalendarFooter = KucBaseDateTimeCalendarFooter;
})();
const BaseDateTimeCalendarFooter = exportBaseDateTimeCalendarFooter as any;
export { BaseDateTimeCalendarFooter };
