...
(() => {
  ...
  class KucMobileMultiChoice extends KucBase {
    ...
    @state()
    private _valueMapping: MobileMultiChoiceValueMapping = {};
    ...
    private _getValueMapping(validProps: MobileMultiChoiceProps) {
      ...
      const result: MobileMultiChoiceValueMapping = {};
      if (_value.length === 0) {
    ...
    private _getValidValue(
      itemsMapping: MobileMultiChoiceValueMapping,
