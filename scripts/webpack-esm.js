...
const fs = require("fs");
const componentDirectories = ["button", "mobile/checkbox","base/mobile-label", "base/mobile-error", "checkbox", "base/error", "base/label", "date-picker", "base/datetime/listbox", "base/datetime/date",
                              "base/datetime/calendar", "base/datetime/calendar", "base/datetime/calendar/body", "base/datetime/calendar/footer", "base/datetime/calendar/header", "base/datetime/calendar/header/dropdown/month",
                              "base/datetime/calendar/header/dropdown/year", "base/datetime/time", "datetime-picker"];
