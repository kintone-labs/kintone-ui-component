...
const fs = require("fs");
const componentDirectories = ["button", "mobile/checkbox","mobile/time-picker","base/mobile-label","base/datetime/mobile-time", "base/mobile-error", "checkbox", "base/error", "base/label"];
