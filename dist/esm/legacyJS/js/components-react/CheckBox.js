...
var CheckBox = function (props) {
    ...
    var items = props.items.map(function (item, i) {
        ...
        return (React.createElement(Item, { key: i, selected: isSelected, onChange: function () { return _handleItemClick(item.value); }, label: item.label, item: item, isDisabled: props.isDisabled ? props.isDisabled : item.isDisabled, type: "checkbox", className: "kuc-input-checkbox-item" }));
    });
