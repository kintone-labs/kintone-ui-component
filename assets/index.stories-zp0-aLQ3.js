import{n as e}from"./chunk-BneVvdWh.js";import{a as t,s as n,t as r}from"./iframe-HX9z8Taj.js";import{a as i,c as a,d as o,f as s,i as c,l,n as u,o as d,r as f,s as p,t as m,u as h}from"./decorate-33sGx9Ox.js";import{n as g,t as _}from"./constant-BNAIZv_2.js";import{n as v,o as y}from"./converter-BYYAaneI.js";import{t as b}from"./error-BtvpQcD5.js";import{t as x}from"./label-D4AWTD2g.js";import{f as S,i as C,s as w,t as T}from"./validator-d05NeqaQ.js";var E,D=e((()=>{E=`
...
`})),O,k,A=e((()=>{r(),a(),g(),v(),b(),p(),x(),u(),T(),D(),(()=>{if(O=window.customElements.get(`kuc-user-org-group-select`),O)return;class e extends f{constructor(e){super(),this.className=``,this.error=``,this.icon=``,this.id=``,this.label=``,this.placeholder=``,this.disabled=!1,this.requiredIcon=!1,this.visible=!0,this.items=[],this.value=[],this._selectedValues=[],this._searchText=``,this._selectorVisible=!1,this._query=``,this._matchingItems=[],this._DISABLED_ITEM_CLASS=`kuc-user-org-group-select__group__container__select-area__select-menu__item--disabled`,this._DISABLED_ICON_CLASS=`kuc-user-org-group-select__group__container__select-area__select-menu__item__icon--disabled`,this._SMALL_ICON_SIZE=24,this._LARGE_ICON_SIZE=48,this._scrollTargets=[],this._GUID=d();let t=S(e);this._handleClickDocument=this._handleClickDocument.bind(this),this._handleScrollMenu=this._handleScrollMenu.bind(this),this._setMenuPosition=this._setMenuPosition.bind(this),this._actionResizeScrollWindow=this._actionResizeScrollWindow.bind(this),Object.assign(this,t)}shouldUpdate(e){if(e.has(`items`)){if(!C(this.items))return this.throwErrorAfterUpdateComplete(_.ITEMS.IS_NOT_ARRAY),!1;if(!w(this.items.map(e=>e.value)))return this.throwErrorAfterUpdateComplete(_.ITEMS.IS_DUPLICATED),!1}return e.has(`value`)&&!C(this.value)?(this.throwErrorAfterUpdateComplete(_.VALUE.IS_NOT_ARRAY),!1):!0}render(){let e=this._getIconType();return n`
      ...
      `}_getSelectedItemTemplate(e,t){let r=this.items.filter(t=>t.value===e)[0];if(!r)return``;let i=r?.disabled,a=r.label===void 0||r.label===null?r.value:r.label;return n`
        <li
        ...
        >
          ...
          >
            ...
            >
              ${this._getSvgTemplateByType(r.type||``,this._SMALL_ICON_SIZE)}
            </div>
            <div
              class="kuc-user-org-group-select__group__container__select-area__selected-list__item__content__text ${i?`kuc-user-org-group-select__group__container__select-area__selected-list__item__content__text--disabled`:``}"
            >
              ${a}
            </div>
          </div>
      ...
      `}_getUserSvgTemplate(e){return t`
        ...
        </svg>`}}m([s({type:String,reflect:!0,attribute:`class`})],e.prototype,`className`,void 0),m([s({type:String})],e.prototype,`error`,void 0),m([s({type:String})],e.prototype,`icon`,void 0),m([s({type:String,reflect:!0,attribute:`id`})],e.prototype,`id`,void 0),m([s({type:String})],e.prototype,`label`,void 0),m([s({type:String})],e.prototype,`placeholder`,void 0),m([s({type:Boolean})],e.prototype,`disabled`,void 0),m([s({type:Boolean})],e.prototype,`requiredIcon`,void 0),m([s({type:Boolean,attribute:`hidden`,reflect:!0,converter:y})],e.prototype,`visible`,void 0),m([s({type:Array})],e.prototype,`items`,void 0),m([s({type:Array})],e.prototype,`value`,void 0),m([l(`.kuc-user-org-group-select__group__container__select-area__select-menu__item`)],e.prototype,`_itemsEl`,void 0),m([h(`.kuc-user-org-group-select__group__container__select-area__toggle__input`)],e.prototype,`_inputEl`,void 0),m([h(`.kuc-user-org-group-select__group__container__select-area__toggle`)],e.prototype,`_toggleEl`,void 0),m([h(`.kuc-user-org-group-select__group__container__select-area__select-menu`)],e.prototype,`_menuEl`,void 0),m([h(`.kuc-user-org-group-select__group__container__select-area__select-menu__item__highlight`)],e.prototype,`_highlightItemEl`,void 0),m([h(`.kuc-user-org-group-select__group__container__select-area__select-menu__item:first-child`)],e.prototype,`_firstItemEl`,void 0),m([h(`.kuc-user-org-group-select__group__container__select-area__select-menu__item:last-child`)],e.prototype,`_lastItemEl`,void 0),m([l(`.kuc-user-org-group-select__group__container__select-area__select-menu__item--disabled`)],e.prototype,`_disabledItemsEl`,void 0),m([o()],e.prototype,`_selectedValues`,void 0),m([o()],e.prototype,`_searchText`,void 0),m([o()],e.prototype,`_selectorVisible`,void 0),window.customElements.define(`kuc-user-org-group-select`,e),c(E),O=e})(),k=O})),j,M,N,P;e((()=>{A(),j={title:`desktop/user-org-group-select`,argTypes:{className:{name:`className`},disabled:{name:`disabled`},error:{name:`error`},icon:{name:`icon`},id:{name:`id`},items:{name:`items`},label:{name:`label`},placeholder:{name:`placeholder`},requiredIcon:{name:`requiredIcon`},value:{name:`value`},visible:{name:`visible`}},parameters:{actions:{handles:[`change`,`click-picker-icon`]}}},M=e=>{let t=new k({...e});return t.addEventListener(`change`,e=>{console.log(e)}),t.addEventListener(`click-picker-icon`,e=>{console.log(e)}),t},N=M.bind({}),N.args={label:`Assignees`,items:[{label:`Alice Johnson (Senior Project Manager, International Business Development Department, Tokyo Headquarters)`,value:`alice`,type:`user`,disabled:!1},{label:`Bob Smith`,value:`bob`,type:`user`,disabled:!0},{label:`Charlie Lee`,value:`charlie`,type:`user`,disabled:!0},{label:`Marketing Group`,value:`marketing-group`,type:`group`,disabled:!0},{label:`Sales Team`,value:`sales-team`,type:`group`,disabled:!1},{label:`Engineering Team`,value:`engineering-team`,type:`group`,disabled:!1},{label:`Acme Corporation`,value:`acme-corp`,type:`org`,disabled:!1},{label:`New York Office`,value:`ny-office`,type:`org`,disabled:!1}],value:[`alice`,`marketing-group`,`acme-corp`],requiredIcon:!0,error:`Error occurred!`,className:`sample-class`,icon:`user`,id:`sample-id`,placeholder:`Please select assignees`,visible:!0,disabled:!1},N.parameters={...N.parameters,docs:{...N.parameters?.docs,source:{originalSource:`args => {
  const orgGroupSelect = new UserOrgGroupSelect({
    ...args
  });
...
}`,...N.parameters?.docs?.source}}},P=[`Base`]}))();export{N as Base,P as __namedExportsOrder,j as default};