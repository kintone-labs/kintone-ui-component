...
|Name|	Type|	Required|	Description|
| --- | --- | --- |---|
|value|	Array&lt;String&gt; |	Yes|The array contains checked value in list.<br> If the <b>value[]</b> has nonexistent value, the valid value will be checked. <br> If the <b>value[]</b> has no valid value, no item will be checked.|
