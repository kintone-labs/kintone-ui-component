---
id: version-1.3.2-mobile-radio-button
...
>
> *2: When users set the value property to empty string, The UI will be empty (no item selected on UI) and get the value property by getter will be empty string, the selectedIndex will be -1.
