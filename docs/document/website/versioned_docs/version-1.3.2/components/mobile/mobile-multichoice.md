---
id: version-1.3.2-mobile-multichoice
...
>
> *2: When users set the value property to empty array, The UI will be empty (no item selected on UI) and get the value and selectedIndex properties by getter will be empty array.
