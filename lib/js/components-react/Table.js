...
var Table = function Table(_ref) {
  ...
  return React.createElement(
    ...
    React.createElement(TableBody, { columns: columns, data: data, defaultRowData: defaultRowData, onRowAdd: onRowAdd, onRowRemove: onRowRemove, _onCellChange: _onCellChange, actionButtonsShown: actionButtonsShown })
  );
};
Table.propTypes = {
...
var TableBody = function TableBody(_ref3) {
  var columns = _ref3.columns,
      data = _ref3.data,
      defaultRowData = _ref3.defaultRowData,
    ...
    data.map(function (rowData, rowIndex) {
      return React.createElement(
        ...
        columns.map(function (column, columnIndex) {
          ...
          if (actions === true) {
            return React.createElement(TableCellActions, Object.assign({ key: columnIndex, data: data, defaultRowData: defaultRowData, rowIndex: rowIndex, addRow: addRow, removeRow: removeRow }, {
...
var TableCellActions = function TableCellActions(_ref5) {
  var data = _ref5.data,
      ...
      defaultRowData = _ref5.defaultRowData,
      addRow = _ref5.addRow,
...
var addRow = function addRow(_ref6) {
  var data = _ref6.data,
      ...
      defaultRowData = _ref6.defaultRowData;

  var insertAt = rowIndex + 1;
  var newData = [].concat(_toConsumableArray(data.slice(0, insertAt)), [Object.assign({}, defaultRowData)], _toConsumableArray(data.slice(insertAt)));
  return newData;
};
