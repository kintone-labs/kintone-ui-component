      ...
      return React.createElement(
        ...
        columns.map(function (column, columnIndex) {
          ...
          return React.createElement(XTableCell, Object.assign({
            key: columnIndex
          }, { rowData: rowData, rowIndex: rowIndex, columnIndex: columnIndex, accessor: accessor, cellRenderer: cellRenderer, tdProps: tdProps }));
        })
      );
    })
  );
...
var XTableCell = function XTableCell(_ref4) {
  var rowData = _ref4.rowData,
      ...
      _ref4$cellRenderer = _ref4.cellRenderer,
      cellRenderer = _ref4$cellRenderer === undefined ? function () {
    return '';
  } : _ref4$cellRenderer,
      tdPropsFn = _ref4.tdProps;

  var cellProps = { rowData: rowData, rowIndex: rowIndex, columnIndex: columnIndex };
  var content = accessor ? getValueByAccessor(accessor, rowData) : cellRenderer(cellProps);
