...
var Table = function () {
  ...
  _createClass(Table, [{
        ...
        for (var _iterator = rowsEl.entries()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          try {
            for (var _iterator2 = this.cellsTemplate.entries()[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
              ...
              var columnIndex = _ref5[0];
              var cellTemplate = _ref5[1];
    ...
    value: function _validateRequired() {
      if (!Array.isArray(this.data) || !Array.isArray(this.columns) || _typeof(this.defaultRowData) !== 'object') {
        throw new Error(Message.common.INVALID_ARGUMENT);
      }
    }
  }, {
    key: '_mapColumns',
    value: function _mapColumns() {
      this.cellsTemplate = this.columns.map(function (_ref6) {
        var cell = _ref6.cell;
      ...
      this.columns = this.columns.map(function (_ref7) {
...
var StatefulTable = function (_React$Component) {
  ...
  function StatefulTable() {
    ...
    return _ret = (_temp = (_this5 = _possibleConstructorReturn(this, (_ref9 = StatefulTable.__proto__ || Object.getPrototypeOf(StatefulTable)).call.apply(_ref9, [this].concat(args))), _this5), _this5.state = {
