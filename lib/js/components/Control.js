...
var Control = function () {
    function Control(props) {
        ...
        this._getReactElement = function () {
            var Component = withState(_this._reactComponentClass);
            var reactElement = React.createElement(Component, _this.props);
            return reactElement;
        };
    ...
    _createClass(Control, [{
        ...
        value: function _renderReactObject(parent) {
            var container = document.createElement('div');
            this._reactObject = ReactDOM.render(this._getReactElement(), container);
