...
var Dropdown = function (_AbstractSingleSelect) {
  _inherits(Dropdown, _AbstractSingleSelect);
  ...
  function Dropdown() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Dropdown.__proto__ || Object.getPrototypeOf(Dropdown)).call.apply(_ref, [this].concat(args))), _this), _this._reactComponentClass = DropdownReact, _temp), _possibleConstructorReturn(_this, _ret);
  }
